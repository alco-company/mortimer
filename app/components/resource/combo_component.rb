...
class Resource::ComboComponent < ViewComponent::Base
    ...
    #                   by really just adding keywords
    #
    # keywords =
    #
    ...
    #   
    # so an few example types would be: single_list, multi_drop, multi_tags, single_drop_search, multi_list_search_add
    #
    # url             - this is the URL which will support a 'lookup' method/action
    # partial         - if different from '/#{url}/lookup' (but the /lookup part is fixed in componen.html.erb)
    ...
    #
    # usage:
    # in your form you'll do something like
